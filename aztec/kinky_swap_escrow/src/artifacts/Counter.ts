...
import CounterContractArtifactJson from '../../target/kinky_swap_escrow-Counter.json' with { type: 'json' };
...
export class CounterContract extends ContractBase {
  ...
  public declare methods: {
    ...
    /** decrement(owner: struct, sender: struct) */
    decrement: ((owner: AztecAddressLike, sender: AztecAddressLike) => ContractFunctionInteraction) & Pick<ContractMethod, 'selector'>;
    ...
    /** increment_self_and_other(other_counter: struct, owner: struct, sender: struct) */
    increment_self_and_other: ((other_counter: AztecAddressLike, owner: AztecAddressLike, sender: AztecAddressLike) => ContractFunctionInteraction) & Pick<ContractMethod, 'selector'>;
